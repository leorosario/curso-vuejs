...
const routes = [
            ...
            { path: 'vendas', component: Vendas, children: 
                [
                    ...
                    { 
                        ...
                        //     // implementado uma lógica para definir as props que serão submetidas para o componente roteado
                        //     return {
                    ...
                    }, //localhost:8080/home/vendas/leads/5
    ...
    { path: '/redirecionamento-5', redirect: to => {
            //podemos programar algo antes do redireiconamento ser efetivado
            console.log(to);
            //return '/home/vendas'
            return { name: 'vendas'}
        }
