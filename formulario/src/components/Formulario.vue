                ...
                <div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <small class="text-muted">Formato: 00.000.000-00</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.placaVeiculo" v-maska="'@@@-####'">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model="form.placaVeiculoMercosul" v-maska="'@@@#@##'">
